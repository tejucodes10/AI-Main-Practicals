...
class GraphVisualization:
    ...
    def visualize_traversal(self, g, o, d, traversal_algorithm, bw = 1):
        ...
        ani = FuncAnimation(fig, update, frames=len(paths) + 1, repeat=False, interval=5000)  # Adjust the interval to control animation speed
        plt.show()
...
GraphVisualization().visualize_traversal(g, 'P', 'S', algo.DFS)
